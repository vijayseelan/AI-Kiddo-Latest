...
import SentenceFeedbackDisplay from '@/components/SentenceFeedbackDisplay'; // Import the new component
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={[styles.floatingButtonsContainer]}>
          ...
          <Text style={[{ fontFamily: 'Poppins_600SemiBold', color: colors.text, fontSize: 16 }]}>{book.title}</Text>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.bottomNavigationContainer}>
          ...
          >
            <ChevronLeft
              size={24}
              color={regularCurrentPage === 0 ? 'rgba(0,0,0,0.3)' : 'black'}
            />
          </Pressable>

          <Text style={styles.bottomPageIndicator}>
            {regularCurrentPage + 1} / {book?.pages?.length ?? 0}
          </Text>
